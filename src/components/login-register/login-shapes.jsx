...
const LoginShapes = () => {
  return (
    <div className="tp-login-shape">
      <Image className="tp-login-shape-1" src={shape_1} alt="shape" />
      <Image className="tp-login-shape-2" src={shape_2} alt="shape" />
      <Image className="tp-login-shape-3" src={shape_3} alt="shape" />
      <Image className="tp-login-shape-4" src={shape_4} priority alt="shape" />
    </div>
  );
};
